...
if __name__ == '__main__':
    ...
    time_rule_07 = rule.TimeSlice(
        stp='2017-07-01 00:00:00', etp='2017-08-01 00:00:00', freq='60min')
    time_rule_08 = rule.TimeSlice(
        stp='2017-08-01 00:00:00', etp='2017-09-01 00:00:00', freq='60min')
    ...
    time_rule_11 = rule.TimeSlice(
        stp='2017-11-01 00:00:00', etp='2017-12-01 00:00:00', freq='60min')
    time_rule_12 = rule.TimeSlice(
        stp='2017-12-01 00:00:00', etp='2018-01-01 00:00:00', freq='60min')
    ...
    data_worker_07 = worker.Worker(
        7, taxi_csv_07.table, time_rule_07, 'new_test', True)

    data_worker_08 = worker.Worker(
        8, taxi_csv_08.table, time_rule_08, 'new_test', True)
    ...
    data_worker_11 = worker.Worker(
        11, taxi_csv_11.table, time_rule_11, 'new_test', True)
    data_worker_12 = worker.Worker(
        12, taxi_csv_12.table, time_rule_12, 'new_test', True)
