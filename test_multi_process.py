...
if __name__ == '__main__':
    ...
    data_worker_07 = worker.Worker(source=taxi_csv_07, destin='yearly_continuous_test', rule=time_rule_07, viz=True)
    data_worker_08 = worker.Worker(source=taxi_csv_08, destin='yearly_continuous_test', rule=time_rule_08, viz=True)
    ...
    data_worker_11 = worker.Worker(source=taxi_csv_11, destin='yearly_continuous_test_mp', rule=time_rule_11, viz=True)
    data_worker_12 = worker.Worker(source=taxi_csv_12, destin='yearly_continuous_test_mp', rule=time_rule_12, viz=True)
